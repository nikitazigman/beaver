"""
Django settings for beaver_api project.
...
MIDDLEWARE = [
    "beaver_api.middleware.HealthCheckMiddleware",
...
WSGI_APPLICATION = "beaver_api.wsgi.application"
...
AUTH_USER_MODEL = "users.BeaverUser"
